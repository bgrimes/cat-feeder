!function e(t, n, r) {
    ...
    1: [ function(require) {
        App = Em.Application.create({}), App.Router = require("./router");
    }, {
        "./router": 2
    } ],
...
}, {}, [ 1, 2 ]), Ember.TEMPLATES.application = Ember.Handlebars.template(function(Handlebars, depth0, helpers, partials, data) {
