!function e(t, n, r) {
    ...
    2: [ function(require) {
        ...
        App.Feeder = require("./models/feeder"), App.User = require("./models/user"), App.Job = require("./models/job"), 
        App.ApplicationAdapter = require("./adapters/application_adapter"), Ember.Handlebars.helper("moment_from_now", require("./helpers/handlebars/moment_from_now"));
    }, {
        ...
        "./controllers/jobs_controller": 6,
        "./controllers/user_controller": 7,
        "./helpers/handlebars/moment_from_now": 8,
        "./models/feeder": 9,
        "./models/job": 10,
        "./models/user": 11,
        "./router": 12,
        "./routes/feeders_route": 13,
        "./routes/jobs_route": 14,
        "./routes/manual_route": 15,
        "./routes/user_route": 16
    } ],
...
}, {}, [ 2, 12 ]), Ember.TEMPLATES.application = Ember.Handlebars.template(function(Handlebars, depth0, helpers, partials, data) {
    ...
    function program1(depth0, data) {
        var stack1, buffer = "";
        return data.buffer.push("\n  "), stack1 = helpers._triageMustache.call(depth0, "comment", {
            hash: {},
            hashTypes: {},
            hashContexts: {},
            contexts: [ depth0 ],
