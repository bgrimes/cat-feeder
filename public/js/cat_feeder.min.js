!function e(t, n, r) {
    ...
    2: [ function(require) {
        ...
        "./helpers/handlebars/moment_from_now": 10,
        "./models/feeder": 11,
        "./models/job": 12,
        "./models/user": 13,
        "./router": 14,
        "./routes/feeders_route": 15,
        "./routes/jobs_route": 16,
        "./routes/manual_route": 17,
        "./routes/user_route": 18
    } ],
    3: [ function(require, module) {
        module.exports = Ember.Controller.extend({});
    }, {} ],
    4: [ function(require, module) {
        var ConfirmMixin = require("./../helpers/confirm_mixin"), FeederController = Ember.ObjectController.extend(ConfirmMixin, {
            needs: [ "user" ],
            isEditing: !1,
            onInit: function() {
            ...
            actions: {
                ...
                deleteFeeder: function() {
                    var feeder = this.get("model"), msg = "Are you sure you want to delete <strong>%@</strong>".fmt(feeder.get("name"));
                    this.confirm(msg).then(function() {
                        feeder.deleteRecord(), feeder.save();
                    });
                }
            }
        });
    ...
    6: [ function(require, module) {
        var ConfirmMixin = require("./../helpers/confirm_mixin"), JobController = Ember.ObjectController.extend(ConfirmMixin, {
            needs: [ "user" ],
            isEditing: !1,
            onInit: function() {
                Ember.run.scheduleOnce("afterRender", this, function() {
            ...
            actions: {
                ...
                deleteJob: function() {
                    var job = this.get("model"), msg = "Are you sure you want to delete <strong>%@</strong>?".fmt(job.get("name"));
                    this.confirm(msg).then(function() {
                        job.deleteRecord(), job.save();
                    });
                }
            }
        });
        ...
        module.exports = Ember.Mixin.create({
            confirm: function(msg) {
                return Ember.Deferred.promise(function(promise) {
                    "object" == typeof bootbox && "function" == typeof bootbox.confirm ? bootbox.confirm(msg, function(result) {
                        result ? promise.resolve() : promise.reject();
                    }) : window.confirm(msg) ? promise.resolve() : promise.reject();
                });
            }
        });
    }, {} ],
...
}, {}, [ 2, 14 ]), Ember.TEMPLATES.application = Ember.Handlebars.template(function(Handlebars, depth0, helpers, partials, data) {
